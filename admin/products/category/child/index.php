...
?>
          ...
          <form method="post" enctype="multipart/form-data">      
            ...
            <div class="subnav clearfix">
              <div class="container clearfix">
                <h1><span class="glyphicon glyphicon-list"></span> &nbsp; <a href="<?php echo $prefix_url."category"?>">Categories</a> <span class="info">/</span> <?php echo $parent['category_name'];?></h1>
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."category";?>"><input type="button" class="btn btn-default btn-sm" value="Back" id="btn-add-category-cancel"></a>
                ...
                <div class="content">
                 ...
                 <div class="actions clearfix">
                   ...
                   <div class="pull-right">
                     ...
                     <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_child_category">
                   </div>
                 </div><!--actions-->
                 ...
                 <table class="table" id="tbl_category">
                   <thead>
                     <tr class="headings">
                       ...
                       <th class="sort" width="10%" onclick="sortBy('total_product')">Sub Category</th>
                     ...
                     <tr class="filter hidden" id="filter">
                       <th><a href="<?php echo $prefix_url."child-category/".$_REQUEST['cid']."/".$_REQUEST['cname'];?>"><button type="button" style="width: 100%;" class="btn btn-danger btn-xs <?php echo $reset;?>"><span class="glyphicon glyphicon-remove"></span></button></a></th>
				   ...
				   foreach($listing_order as $all_category){
				      $row++;
				      $getTotal = count_products($all_category['category_id']);
					  $sub_total = count_sub_category($all_category['category_id'], 1);
				   ?>
                      <tr id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                        ...
                        <td>
                          <a href="<?php echo $prefix_url."child-category/".$all_category['category_id']."/".cleanurl($all_category['category_name']);?>" onclick="freechecked()">
                         ...
                         <td>
                           <a href="<?php echo $prefix_url."product-view/1/top/25/product_name/product_category-".$all_category['category_id'];?>">
						      <?php echo $getTotal['rows'];?>
                           </a>
                         </td>
                         <td>
						   <?php 
						   //echo $all_category['category_active_status'];
						   echo $sub_total['rows'];
						   ?>
                         </td>
		 ...
		 <?php
		 // INPUT HIDDEN
		 echo '<input type="hidden" name="hidden_category_parent_id" value="'.$_REQUEST['cid'].'">';
		 echo '<input type="hidden" name="hidden_category_parent" value="'.$_REQUEST['cname'].'">';
		 ?>
</form>
