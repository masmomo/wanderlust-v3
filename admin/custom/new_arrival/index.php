                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo $tr_class;?>" id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                                ...
                                <div id="ajax_remove_wrapper_<?php echo $sale['product_id']?>">
                                   ...
                                   <div class="btn btn-danger btn-sm" style="position: absolute; right: 5px; top: 15px" onclick="ajxRemoveSale('<?php echo $sale['product_id'];?>')">Remove</div>
...
function ajxRemoveSale(i){
   ...
   var ajx = $.ajax({
	            type: "POST",
				url: "<?php echo $prefix_url;?>custom/new_arrival/ajax_remove.php",
				data: {itemID:itemID},
