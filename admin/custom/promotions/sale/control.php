...
if(isset($_POST['btn_sale_add'])){
   ...
   if($_POST['btn_sale_add'] != "Remove All Discounts"){
      //DEFINED VALUE 
      ...
      foreach($promo_type_id as $promo_type_id){
         updateSale($promo_id, $promo_type_id, $promo_value, $promo_start, $promo_end);
      }
	  
	  $_SESSION['alert'] = "success";
	  $_SESSION['msg']   = "Successfully added promo(s)";
	  
   }else if($_POST['btn_sale_add'] == "Remove All Discounts"){
      deleteAllSale();
