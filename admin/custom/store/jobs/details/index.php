    ...
    <div class="subnav">
      <div class="container clearfix">
        ...
        <div class="btn-placeholder">
          ...
          <input type="submit" class="btn btn-danger btn-sm" value="Delete" name="btn_detail_store_job">
          <input type="button" class="btn btn-success btn-sm" value="Save Changes" id="btn_alias">
          <input type="submit" class="hidden" value="Save Changes" name="btn_detail_store_job" id="btn_save">
        </div>
      </div>
    </div>
