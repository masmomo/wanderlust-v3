                ...
                <div class="content">
                 ...
                 <div class="actions clearfix">
                   ...
                   <div class="pull-right">
                     ...
                     <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_index_store_job">
                   </div>
                 </div><!--actions-->
                 ...
                 <table class="table">
                   <thead>
                     <tr class="headings">
                       <th width="20">
                         <span id="eyeopen" class="glyphicon glyphicon-eye-open" onclick="showEye()"></span>
                       </th>
                   ...
                   <tbody>
                     ...
                     <td>
					   <a href="<?php echo $prefix_url.'store-detail/'.$all_category['career_id'].'/'.cleanurl($all_category['career_name']);?>">
